        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            if ($userType == 'super-admin' || $userType == 'admin') {
			 ...
			 <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>all-commission">
            ...
            if ($userType == 'super-admin' || $userType == 'admin') {
			 ...
			 <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="<?php echo base_url(); ?>affiliate-request">
                                <i class="fa fa-arrow-circle-o-right"></i>New Affiliate Request</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>cookie-time-set">
                                <i class="fa fa-arrow-circle-o-right"></i>Cookies Setting</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>payment-request">
                                <i class="fa fa-arrow-circle-o-right"></i>Payout Request </a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>affiliate-profile">
                                <i class="fa fa-arrow-circle-o-right"></i>Affiliator's Profile</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>affiliate-order-list">
                                <i class="fa fa-arrow-circle-o-right"></i>Order List</a>
                        </li>
                        <li><a href="<?php echo base_url(); ?>bill-closing">
                                <i class="fa fa-arrow-circle-o-right"></i>Bill Closing</a></li>
                        <li><a href="<?php echo base_url(); ?>voucher-list">
                                <i class="fa fa-arrow-circle-o-right"></i>Payment History/Voucher List</a></li>
                    </ul>
                </li>
                ...
                <li hidden class="treeview "><a href="#"> <i class="fa fa-wrench"></i> <span>Tools</span> <span
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li hidden><a href="<?php echo base_url(); ?>expense-category-list"> <i
                                    class="fa fa-wrench"></i> <span>Expense Types</span>
                            </a></li>
                ...
                <li class="treeview ">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li hidden><a href="<?php echo base_url(); ?>setting-extra"> <i class="fa fa-circle-o"></i>
                        ...
                        <li hidden><a href="<?php echo base_url(); ?>setting-popup"> <i class="fa fa-circle-o"></i>
                                <span>Popup Settings</span>
                            </a></li>
                        <li hidden><a href="<?php echo base_url(); ?>setting-facebook"> <i
