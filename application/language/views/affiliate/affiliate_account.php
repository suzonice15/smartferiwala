...
<div class="col-lg-9">
        ...
        <div class="tab-content">
                ...
                <form action="#" id="information_add" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4" style="display: none;" id="mobile_payment_info_bkash">
                                <label><b>Mobile Number</b>&nbsp;<span id="j1" style="color: red;"></span></label>
                                <input type="text" pattern="[0-9]{11}" name="phone_account_no_bkash" id="phone_account_no_bkash"
                                       class="form-control">
                            </div>
                            
                            <div class="col-md-4" style="display: none;" id="mobile_payment_info_rocket">
                                <label><b>Mobile Number</b>&nbsp;<span id="j2" style="color: red;"></span></label>
                                <input type="text" pattern="[0-9]{12}" name="phone_account_no_rocket" id="phone_account_no_rocket"
                                       class="form-control">
                            </div>
                ...
                <div class="aw-aff-balance-info">
                    <ul>
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label">Hits</span>
                        ...
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label">Orders</span>
                            <span class="balance-value" data-bind="text: balance.value">
                                  <?php
                        ...
                        <li class="balance-element">
                            <span class="balance-label"
                                  data-bind="text: balance.label">On Process(Till delivered status)</span>
                            <span class="balance-value" data-bind="text: balance.value">
                                <?php
                        ...
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label">Cancelled/Refund</span>
                            <span class="balance-value" data-bind="text: balance.value">
                                  <?php
                        ...
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label">Finalized</span>
                            <span class="balance-value" data-bind="text: balance.value">
                                 <?php
            ...
            <div id="balance" class="tab-pane fade">
                ...
                <table class="table table-bordered table-striped table-hover">
                        ...
                        foreach ($my_create_link as $v_link) {
                            $i++;
                            $total++;
                            $comm = $this->MainModel->select_product_commission_affiliate($v_link->product_id);
                            if($comm->discount_price){
                                $set_price = ($comm->discount_price);
                                $get_amount = (($set_price * $comm->commission)/100);
                            }else{
                                $get_amount = (($comm->product_price * $comm->commission)/100);
                            }
                            ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                             ...
                             foreach ($count_commission as $v_comm) {
                                 ...
                                 if (is_array($product_items['items'])) {
                                     foreach ($product_items['items'] as $product_id => $item) {
                                         $result = $this->MainModel->select_product_commission($product_id);
                                         if($v_link->product_id == $product_id){
                            ...
                            foreach ($count_buy_on_process as $v_order_id) {
                                ...
                                if (is_array($product_items['items'])) {
                                    foreach ($product_items['items'] as $product_id => $item) {
                                        ...
                                        $result = $this->MainModel->select_product_commission($v_link->product_id);
                                        if($v_link->product_id == $product_id){
                                        $count_total_on_process_commission += $result->commission * $item['qty'];
                                    }
                                    }
            ...
            <div id="transactions" class="tab-pane fade">
                ...
                <div class="aw-aff-balance-info">
                    <ul>
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label" style="color: white;">Order Finalized</span>
                        <span class="balance-value" data-bind="text: balance.value" style="color: white;">
                                <?php
                                $count_total_finalized_commission = 0;
                                $total_paid_commission = $this->MainModel->count_total_paid_commission($user_id);
                        ...
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label" style="color: white;">(-)Total Paid</span>
                        <span class="balance-value" data-bind="text: balance.value" style="color: white;">
                                ৳
                            <?php
                            $total_paid_commission = $this->MainModel->count_total_paid_commission($user_id);
                            echo round($total_paid_commission->total_commission_request, 2); ?>
                        </span>
                        </li>
                        <li class="balance-element">
                            <span class="balance-label" data-bind="text: balance.label" style="color: white;">Available Commission</span>
                        <span class="balance-value" data-bind="text: balance.value" style="color: white;">
                                ৳
                            <?php
                            $commission_amount = round($count_total_finalized_commission - $total_paid_commission->total_commission_request, 2);
                            echo round($count_total_finalized_commission - $total_paid_commission->total_commission_request, 2); ?>
                        </span>
                        </li>
                    </ul>
                </div>
                ...
                <p id="payment_one_msg" style="display: none; font-size: 16px;">One of your payout request still
                    pending, please wait for
                    the payment clearance
                </p>
                <p id="payment_two_msg" style="display: none; font-size: 16px;">Your available commission is less then
                    500 taka…. You are
                    not allowed to make payout request.</p>
                <p id="payment_three_msg" style="display: none; font-size: 16px;">Payout request can be send once in a
                    month & you not
                        ...
                        <div class="from-group">
                            <div class="row">
                                ...
                                <div class="col-md-8"><span
                                        style="color: red; font-size: 18px;"></span> <?php echo $v_request->cancel_note; ?>
                                </div>
                            </div>
                        </div>
                        <br>
                        <form action="#" id="affiliate_request_frm" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input onblur="check_change(1)" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" onblur="check_change(2)" required="required"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="email" onblur="check_change(3)"
                                               required="required"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                <textarea onblur="check_change(4)" name="present_address" required="required"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                <textarea onblur="check_change(5)" name="permanent_address"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input onblur="check_change(6)" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input onblur="check_change(7)" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input onblur="check_change(8)" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input onblur="check_change(9)" type="text"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3"><b>That's Your Promotional Strategy? Write Details <span
                                                ...
                                                *</span></b></div>
                                    <div class="col-md-6">
                                <textarea onblur="check_change(10)" name="promotional_strategy" required="required"
                                    ...
                                    <div class="col-md-7" id="hide_condition">
                                        <input type="checkbox" value="1" id="condition"> <b>I have read & agree
                                            to Ekusheyshop <a target="_blank"
                                                              href="<?= base_url() ?>pages/terms-conditions">Privacy
    ...
    <script>
        function set_error_msg() {
            ...
            $('#error_msg').html('Please select terms and conditions');    
            }
        }
    </script>
    <script>
    ...
    <script>
        function select_payment_method() {
            ...
            if (payment_type == 1) {
                $('#mobile_payment_info_bkash').show();
                $('#mobile_payment_info_rocket').hide();
                $('#bank_payment_info').hide();
                $('#cash_payment_info').hide();
            } else if (payment_type == 2) {
                $('#mobile_payment_info_rocket').show();
                $('#mobile_payment_info_bkash').hide();
                $('#bank_payment_info').hide();
                $('#cash_payment_info').hide();
    ...
    <script>
        $(document).ready(function () {
            ...
            function validation() {
                var payment_type = $('#payment_type').val();
                var phone_account_no_bkash = $('#phone_account_no_bkash').val();
                var phone_account_no_rocket = $('#phone_account_no_rocket').val();
                ...
                if (payment_type == 1) {
                    if (phone_account_no_bkash.length == "") {
                    ...
                    if (phone_account_no_rocket.length == "") {
