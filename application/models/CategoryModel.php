...
Class CategoryModel extends CI_Model
{
	...
	public function scroll_home_product($start,$limit,$home)
	{



		$this->db->select('product_name,product.product_id,product_title,product_price,discount_price,sku,product_stock,discount_type,product_availability');
		$this->db->from('product');
		$this->db->join('term_relation', 'product.product_id = term_relation.product_id');
		$this->db->order_by('modified_time', 'DESC');
		$this->db->where('product_type', $home);
	...
	public function scroll_related_product($product_id,$category_id,$start,$limit)
	{
