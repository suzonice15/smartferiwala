...
$route['affilator-order-view/(:any)'] = 'order/OrderController/afflilator_order_view/$1';
...
$route['payment-request'] = 'order/OrderController/all_payment_request';
...
$route['bill-closing'] = 'order/OrderController/all_bill_closing';
$route['affiliate-profile'] = 'order/OrderController/all_affiliate_profile';
$route['voucher-list'] = 'order/OrderController/all_voucher_list';
$route['affiliate-order-list'] = 'order/OrderController/all_affiliate_order_list';
$route['set-closing-date'] = 'order/OrderController/set_closing_date';
$route['affiliate-request'] = 'order/OrderController/all_affiliate_request';
...
$route['add-commission/(:any)'] = 'product/ProductController/single_commission/$1';
$route['all-commission'] = 'product/ProductController/all_commission';
