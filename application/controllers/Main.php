...
class Main extends CI_Controller {
	...
	public function index() { 
         set_cookie('cookie_name','cookie_value','60'); 
	...
	public function success_payment()
	{
		...
		if(($sesdata['tran_id'] == $_POST['tran_id']) && ($sesdata['amount'] == $_POST['currency_amount']) && ($sesdata['currency'] == 'BDT'))
		{
			...
			{
				$this->session->set_userdata('sslcommerz_data', $_POST);
	...
	{
		redirect('checkout/thank-you/?directpay=fail', 'refresh');
	}
	public function cancel_payment()
	{
		redirect('checkout/thank-you/?directpay=cancle', 'refresh');
	}
