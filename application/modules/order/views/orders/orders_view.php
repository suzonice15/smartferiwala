    ...
    <div class="box box-success ">
        ...
        <div class="box-body">
            <section class="content">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="bkash_payment" value="<?php echo $order->bkash_payment; ?>"
                                                 ...
                                                 <div class="form-group">
                                                <label>Remark</label>
                                                <input name="order_remark" value="<?php echo $order->order_remark; ?>"
                                                       class="form-control">
                                            </div>
                                        </div>
								...
								<select name="products[items][' . $product_id . '][Color]"  id="productSize" class="form-control item_color" >';
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ৳ <span
                                                        id="subtotal_cost"> <?php echo $subtotal_price . '.00' ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
				...
				<input type="text"  class="form-controll" id="shipping_charge_suzon" name="shipping_charge"
                       value="<?= $order->shipping_charge; ?>"/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                   	...
                                                   	<input type="text"  class="form-controll" id="order_total" name="order_total"
                       value="<?= $order->order_total; ?>"/> 
                                    ...
                                    <?php if ($order->order_status == 'completed' || $order->order_status == 'cancled' || $order->order_status == 'refund') {
                                        
                                        ?> 
                                        
                                        <a href="<?php echo base_url()?>order-list" class="btn btn-info pull-right">Close</a>
                                        <?php } else {  ?>
