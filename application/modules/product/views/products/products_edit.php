	...
	<div class="box-body">
		...
		<form action="<?php echo base_url()?>product-update"  name="proudctUpdate" method="post" enctype="multipart/form-data" >
						...
						<div class="box box-primary" style="border: 2px solid #ddd;" >
							...
							<div class="box-body">
								<div class="form-group  ">
									...
									<input type="text" class="form-control the_title" name="product_title" id="product_title_" value="<?php if(isset($product)) : echo  $product->product_title;endif ; ?>">
			...
			-->
				...
				<div class="box-body">
					<div class="form-group ">
						<textarea  class="form-control ckeditor " rows="10" name="product_summary" id="product_summary"><?php if(isset($product)) : echo  $product->product_summary;endif ; ?> </textarea>
					</div>
				</div>
			</div>
			...
			<div class="box box-primary" style="border: 2px solid #ddd;" >
				...
				<div class="box-body">
					<div class="form-group ">
						<textarea       class="form-control ckeditor " rows="15" name="product_description" id="product_description"><?php if(isset($product)) : echo  $product->product_description;endif ; ?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="box box-primary" style="border: 2px solid #ddd;" >
				...
				<div class="box-body">
					<div class="form-group ">
						<textarea class="form-control ckeditor " rows="5" name="product_terms" id="product_terms"><?php if(isset($product)) : echo  $product->product_terms;endif ; ?></textarea>
					</div>
				</div>
			</div>
